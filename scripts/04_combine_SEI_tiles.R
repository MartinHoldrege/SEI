  ...
  r_names <- c('SEIv11_1998_2001_30_Current_20220718',
             ...
             'SEIv11_2008_2011_30_Current_20220718',
             'SEIv11_2013_2016_30_Current_20220718',
             'SEIv11_2017_2020_30_Current_20220717')
  names(r_names) <- r_names
  
  r_names <- r_names[4] # just running for subset of files
  ...
  path_l <- map(r_names, function(x) {
    ...
    # after that
    list.files(file.path(path, "SEI_rasters/tiles/"),
               pattern = x,
               full.names = TRUE)
  })
